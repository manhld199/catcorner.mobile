  ...
  return (
    <ScrollView className="flex-1 bg-gray-50 px-4 py-6">
      ...
      <View className="bg-white shadow rounded-lg p-4 mb-6">
        ...
        <Text className="text-gray-500">
          Đơn hàng của bạn đã được ghi nhận và sẽ được xử lý sớm nhất. Hãy kiểm
          tra email hoặc thông tin liên hệ để biết thêm chi tiết.
        </Text>
      </View>
      ...
      <View className="mt-6 mb-16">
        ...
        >
          <Text className="text-white text-center font-c-bold">
            Tiếp tục mua sắm
          </Text>
        </TouchableOpacity>
        ...
        {userInfo && (
          <TouchableOpacity
            ...
            className="border border-teal-500 bg-white p-4 rounded-lg"
          >
            <Text className="text-teal-500 text-center font-c-bold">
