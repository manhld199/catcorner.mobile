  ...
  return (
    <>
      <ScrollView className="flex-1 bg-bg-1 dark:bg-gray-800 px-6 py-8">
        <Text className="text-3xl font-c-bold text-gray-800 dark:text-pri-2 text-center">
          Tra cứu đơn hàng
        </Text>
        ...
        <View className="mt-8">
          <Text className="text-gray-700 dark:text-teal-300 font-medium mb-2">
            Mã đơn hàng:
          </Text>
          <Input
          ...
          <TouchableOpacity
            className="border-2 border-teal-700 dark:border-teal-400 rounded-full py-4"
