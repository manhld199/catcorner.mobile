...
export default function CardCoupon() {
  return (
    <TouchableOpacity className="w-[30%] aspect-[3/4] overflow-hidden bg-teal-100 rounded-lg flex flex-col gap-2 items-center">
      <View className="w-full py-1 border-b-2 border-dashed border-white bg-teal-200">
      ...
      <View className="px-2 flex flex-row gap-1 items-center">
        ...
        <Text className="text-base text-green-500">Đã nhận</Text>
      </View>
    </TouchableOpacity>
  );
}
