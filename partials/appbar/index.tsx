...
export default function AppBar() {
  return (
    <View className="absolute bottom-6 w-full flex flex-row justify-around items-center bg-white dark:bg-black py-3 border-t dark:border-black border-gray-200">
      {tabData.map((tab) => (
        <TabItem
          key={tab.href}
          href={tab.href}
